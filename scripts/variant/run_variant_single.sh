...
#
# 使い方:
#   bash scripts/variant/run_variant_single.sh <variant_id> <variant_name> [outbase] [gpu_id]
#
# 例:
#   bash scripts/variant/run_variant_single.sh 0 lstm_baseline outputs/variant_comparison_server 0

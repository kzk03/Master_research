...
class IRLReward(RewardFunction):
    ...
    def _load_model(self) -> None:
        ...
        TODO: 以下を実装する
        ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        IRL/model/irl_predictor.py を読んで、以下を確認すること:
            1. IRLPredictor はどう初期化するか？（引数は何か）
            2. モデルのロードメソッドの名前は何か？（load_model? load?）
            3. スコア計算メソッドの名前は何か？（predict? score? forward?）

        実装例（irl_predictor.py の実際の API に合わせて調整すること）:
            from IRL.model.irl_predictor import IRLPredictor
            predictor = IRLPredictor(feature_dim=14)
        ...
        raise NotImplementedError(
            "TODO: IRL モデルのロード処理を実装してください。\n"
            "IRL/model/irl_predictor.py の load_model を参照してください。"
        )
    ...
    def compute(
        ...
        # TODO: ここに IRL モデルへの入力とスコア取得を実装する
        irl_score: float = 0.0  # ← 仮の値。実装後はモデルの出力に置き換える
